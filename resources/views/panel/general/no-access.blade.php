...
<head>
    ...
    <title>Lock Screen - Vuexy - Bootstrap HTML admin template</title>
    ...
    <!-- BEGIN: Vendor CSS-->
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/panel/app-assets/vendors/css/vendors-rtl.min.css') }}">
    <!-- END: Vendor CSS-->
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/panel/css-rtl/persian-font.css') }}">
    <!-- END: Custom CSS-->
                    ...
                    <div class="card bg-authentication rounded-0 mb-0 w-100">
                        <div class="row m-0">
                            <div class="col-lg-6 d-lg-block d-none text-center align-self-center px-1 py-0">
                                <img src="{{ asset('assets/panel/images/pages/lock-screen.png') }}" alt="branding logo">
                            </div>
                            <div class="col-lg-6 col-12 p-0">
                                <div class="card rounded-0 mb-0 px-2 pb-2">
                                    <div class="card-header pb-1">
                                        <div class="card-title mt-2">
                                            <h4 class="mb-0">شما مجوز لازم برای دسترسی به این بخش را ندارید.</h4>
                                        </div>
                                    </div>
                                    <div class="card-content mt-5">
                                        <div class="card-body pt-1">
                                            <p class="text-center">لطفا برای اطلاعات بیشتر با پشتیبانی تماس بگیرید.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
